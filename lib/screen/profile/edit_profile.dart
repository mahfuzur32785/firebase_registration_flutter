...
class EditProfile extends StatefulWidget {
  EditProfile({Key? key, this.name, this.phone, this.address, this.img})
      : super(key: key);
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                          child: Text(
                        'Note : Email address can not be modify',
                        style: TextStyle(color: Color(0xFFBEB34C)),
                      )),
                      SizedBox(
                        height: 20,
                      ),
                          ...
                          Expanded(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                ...
                                (Provider.of<FireBaseHelper>(context,
                                        listen: false)
                                    .updateUserProfile(
                                        img: img,
                                        imageFile: imageFile,
                              ...
                              child: (Provider.of<FireBaseHelper>(context)
