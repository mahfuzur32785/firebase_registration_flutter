...
typedef ItemBuilder = Widget Function(BuildContext context, MyNavbarItem items);
...
class _MyNavBarState extends State<MyNavBar> {
  List<MyNavbarItem> get items => widget.items!;
...
ItemBuilder _defaultItemBuilder({
  ...
  return (BuildContext context, MyNavbarItem item) => Expanded(
    child: Row(
      mainAxisSize: MainAxisSize.min,
